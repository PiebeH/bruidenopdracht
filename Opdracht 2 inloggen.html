...
@media screen and (max-width: 600px) {
  ...
  .topnav a, .topnav input[type=text], .topnav .signupbtn {
    float: none;
    display: block;
    text-align: left;
    width: 100%;
    ...
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <div class="w3-container">
         <p> If you want to change your wishlist, click <a href=wishlist.html>here</a></p>
        </div>
       <div class="w3-container">
            ...
            <ul class="w3-ul w3-card-4">
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://img0.etsystatic.com/048/1/7624589/il_fullxfull.707301638_6om6.jpg" alt="pebble art" class="w3-bar-item w3-circle w3-hide-small" style="width:160px">
              ...
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://cdn.quotesgram.com/img/51/55/1562729440-IMG_8189.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:160px">
                <div class="w3-bar-item">
              ...
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://i.pinimg.com/736x/b8/3a/33/b83a336492a2bf0355ac167acf02d126--wedding-presents-for-couples-best-wedding-gifts-for-couple.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:150px">
                <div class="w3-bar-item">
              ...
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://i.pinimg.com/originals/b9/be/ed/b9beeda9018a2631daa5f252061d9ca5.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:160px">
                <div class="w3-bar-item">
              ...
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://heavyeditorial.files.wordpress.com/2016/08/a1mvgr-ig0l-_sl1500_.jpg?quality=65&strip=all&strip=all" class="w3-bar-item w3-circle w3-hide-small" style="width:160px">
                <div class="w3-bar-item">
              ...
              <li class="w3-bar">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-white w3-xlarge w3-right">Choose</span>
                <img src="https://img0.etsystatic.com/104/0/6177166/il_fullxfull.1041577526_sg3t.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:160px">
                <div class="w3-bar-item">
